...
final_arr = arrivals_2019_day[["airline", "arrival", "icao24", "day", "arr time minute", "series", "callsign"]].copy()
...
db_voli.to_csv("DBvoli_" + day_dict[day] + ".txt", index_label=False, index=False, sep="\t")
