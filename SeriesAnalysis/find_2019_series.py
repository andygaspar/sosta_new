...
def check_airline_series(airline, df_airline, df_18, airport_list, week_day):
...
for airline in df_eu_day.airline.unique():
    ...
    db_s, db_v = check_airline_series(airline, df_airline, df_air_18, airport_list, week_day)
