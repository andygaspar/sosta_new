...
for day in day_dict.keys():
    ...
    with open('results/19/'+day_dict[day]+'/struttura'+day_dict[day]+'.txt', mode='w') as employee_file:
        writer = csv.writer(employee_file, delimiter='\t', escapechar='\t', quoting=csv.QUOTE_NONE)
